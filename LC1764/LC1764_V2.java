...
//            System.out.println(Arrays.toString(groups[i]));
            int start = kmpSearch(nums,groups[i],next,lastindex);
            lastindex = start;
    ...
    public static int kmpSearch(int[] str1, int[] str2, int[] next,int start) {
